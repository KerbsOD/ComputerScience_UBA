...
tres:    	   dd 3, 3, 3, 3
cuatro:        dd 4, 4, 4, 4
treintaYdos:   dd 32, 32, 32, 32
noventaYseis:  dd 96, 96, 96, 96
cientosesenta: dd 160, 160, 160, 160
dosdoscuatro:  dd 224, 224, 224, 224
...
temperature_asm:
	...
	movdqu   xmm1, [tres]			; | 3 | 3 | 3 | 3 |
	movdqu   xmm4, [cuatro]			; | 4 | 4 | 4 | 4 |
	pmovzxdq xmm1, xmm1				; | 3 | 3 |. Como solo puedo procesar 2 pixeles a la vez, guardo 2 tres para dividir.
...
.TmenorA32:
	...
	pmulld xmm3, xmm4				; Multiplico t por 4.
...
.TmenorA96:
	...
	pmulld   xmm3, xmm4				; Multiplico todo por 4. |0|0|(t-32)*4|0|. 
...
.TmenorA160:
	...
	pmulld   xmm3, xmm4				; Multiplico todo por 4. |(t-96)*4|0|(t-96)*4|0|
...
.TmenorA224:
	...
	pmulld   xmm3, xmm4				; Multiplico todo por 4. |0*4|(t-160)*4|0*4|0*4|
...
.TmayorA224:
	...
	pmulld   xmm3, xmm4				; Multiplico todo por 4. |0*4|0*4|(t-224)*4|0*4|
