...
product_2_f:
	...
	cvtsi2ss xmm1, rsi	; Convierto int to float
	mulss xmm0, xmm1	; Multiplicamos los floats
	cvtss2si rsi, xmm0  ; Convierto el float a int
	mov [rdi], rsi      ; Muevo el valor a la direccion que me pasaron
